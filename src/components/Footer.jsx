...
const Footer = () => {
  ...
  const solutions = [
    { label: 'PetaScan / PetaTag', href: '#solutions' },
    { label: 'PetaParking', href: '#solutions' },
    { label: 'PetaLog', href: '#solutions' },
    { label: 'Tech Fusion', href: '#solutions' }
  ];
        ...
        <div className="footer-content">
          <div className="footer-section">
            <div className="footer-brand">
              <img 
                src="/lovable-uploads/5efa8646-10b2-435e-b5bc-d219b5e45199.png" 
            ...
            <p className="footer-description">
              ...
              AI-driven systems, and comprehensive tech education programs.
            </p>
          ...
          <div className="footer-section">
            <h4 className="footer-section-title">Our Solutions</h4>
            <ul className="footer-links">
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              ...
              <div className="contact-item">
                ...
                <a href="tel:+917012422309" className="contact-link">
                  +91 7012422309
                </a>
              </div>
              <div className="contact-item">
